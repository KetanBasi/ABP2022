...
{{-- SECTION: Variables --}}
@section('breadcrumb_current_location', 'Customer'     )
@section('table_title'                , 'List Customer')
{{-- !SECTION: Variables --}}
...
{{-- ANCHOR: Navigation --}}
@section('nav_list')
    @include('base.components.nav_list', ['active' => 'customer'])
@endsection
                ...
                <div class="card my-4">
                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg p-4 row justify-content-between d-flex">
                            ...
                            <a href="/customer/create" onclick="" class="btn bg-gradient-light border-radius-lg p-2 m-0 col-1 font-weight-bold text-primary position-absolute align-self-center end-0" style="width: max-content;">
                                + Add Customer
                            </a>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <!-- ANCHOR: Produk Data -->
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">{{ $item->nama_customer }}</h6>
                                                ...
                                                <!-- ANCHOR: Col. 2 - Address -->
                                                <td class="align-middle text-sm">
                                                    <span class="text-xs font-weight-bold mb-0">{{ $item->alamat }}</span>
                                                    {{-- <p class="text-xs text-secondary mb-0">Total: {{ $item->harga * $item->stok }}</p> --}}
                                                </td>

                                                <!-- ANCHOR: Col. 3 - Contacts -->
                                                <td class="text-center text-sm">
                                                    <span class="badge badge-sm bg-gradient-primary">{{ $item->no_hp }}</span>
                                                </td>
                                                ...
                                                <td class="align-middle">
                                                    ...
                                                    <a class="btn bg-gradient-warning border-radius-lg p-2 text-light text-xs" href="/customer/edit/{{$item->id}}" onclick="">Edit</a>
